...
module.exports = app => {
    class ProductCategoryController extends app.Controller {
        ...
        async list(ctx) {
            ...
            let data = await this.service.productCategory.list(params);
            this.logger.info(data);
            await this.ctx.render("productCategory/list.html", {data: data, params});
        };
        ...
        async delete(ctx) {
            ...
            this.app.logger.info(params);
            let data = await this.service.productCategory.delete(params);
        ...
        async edit(ctx) {
            ...
            if (id) {
                let data = await this.service.productCategory.get({id: id});
        ...
        async edit_(ctx) {
            ...
            let data = await this.service.productCategory.edit(params);
            this.ctx.body = data;
        };
    }
