...
//     let data = yield this.service.merchant.list(params);
...
exports.list = function* (ctx) {
    ...
    // this.app.logger.info(params);
    // let data = yield this.service.merchant.list(params);
    yield this.render("merchant/list.html");
};
...
exports.delete = function* (ctx) {
    ...
    this.app.logger.info(params);
    let data = yield this.service.merchant.delete(params);
...
//     let menus = yield this.service.merchant.menu();

//     if (id){
//         let data = yield this.service.merchant.get({id: id});
//         yield this.render("merchant/edit.html", {data, params, menus});
//         return;
//     }
//     yield this.render("merchant/edit.html", {params, menus});
...
exports.edit = function* (ctx) {
    ...
    //     return;
    // }
    yield this.render("merchant/edit.html");
...
exports.edit_ = function* (ctx) {
    this.validate(rule);
    let params = this.request.body;
    let data = yield this.service.merchant.edit(params);
...
exports.usernameIsExist = function* (ctx) {
    ...
    if (!params.username){
        ...
        let data = yield this.service.merchant.usernameIsExist(params);
        yield this.body = data;
    }
};
...
exports.mobileIsExist = function* (ctx) {
    ...
    let data = yield this.service.merchant.mobileIsExist(params);
    yield this.body = data;
};
...
exports.modifyPassword = function* (ctx) {
    yield this.render("merchant/modify_password_dialog.html");
}
...
exports.modifyPassword_ = function* (ctx) {
    ...
    const data = yield this.service.merchant.modifyPassword(params);
